...
public:
	...
	afx_msg void OnRclickListMtr(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnMenuCopyip();
	afx_msg void OnMenuWhois();
	afx_msg void OnMenuIpip();
